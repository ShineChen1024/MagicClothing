...
def process(cloth_image, cloth_mask_image, prompt, a_prompt, n_prompt, num_samples, width, height, sample_steps, scale, seed, person_image, person_mask):
    inpaint_image = make_inpaint_condition(person_image,person_mask)
    images, cloth_mask_image = full_net.generate(cloth_image, cloth_mask_image, prompt, a_prompt, num_samples, n_prompt, seed, scale, sample_steps, height, width, image=inpaint_image)
...
with block:
    ...
    ips = [cloth_image, cloth_mask_image, prompt, a_prompt, n_prompt, num_samples, width, height, sample_steps, scale, seed, person_image, person_mask]
