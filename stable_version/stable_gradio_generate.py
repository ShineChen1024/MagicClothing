...
from garment_adapter.garment_diffusion_stable import ClothAdapterStable
...
parser.add_argument('--pipe_path', type=str, default="stablediffusionapi/counterfeit-v30")  # stablediffusionapi/counterfeit-v30 SG161222/Realistic_Vision_V4.0_noVAE
...
full_net = ClothAdapterStable(pipe, garment_extractor_path, garment_ip_layer_path, device, args.enable_cloth_guidance)
